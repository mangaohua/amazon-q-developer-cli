...
pub enum EmbeddingType {
    ...
    Fast,
    /// Best embedding using all-MiniLM-L6-v2 (not available on Linux ARM or Android)
...
// All platforms except Linux ARM and Android: Use Best (all-MiniLM-L6-v2)
#[cfg(not(any(target_os = "android", all(target_os = "linux", target_arch = "aarch64"))))]
...
// Linux ARM and Android: Use Fast (BM25)
